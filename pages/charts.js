  ...
  return (
    <div className={styles.container}>
      ...
      <div className="quick-sidebar">
        <a href="charts.html#" className="close-quick-sidebar">
        ...
        <div className="quick-sidebar-wrapper">
          <ul className="nav nav-tabs nav-line nav-color-primary" role="tablist">
            <li className="nav-item"> <a className="nav-link active show" data-toggle="tab" href="charts.html#messages" role="tab" aria-selected="true">Messages</a> </li>
            <li className="nav-item"> <a className="nav-link" data-toggle="tab" href="charts.html#tasks" role="tab" aria-selected="false">Tasks</a> </li>
            <li className="nav-item"> <a className="nav-link" data-toggle="tab" href="charts.html#settings" role="tab" aria-selected="false">Settings</a> </li>
          </ul>
              ...
              <div className="messages-wrapper">
                ...
                <div className="messages-form">
                  ...
                  <div className="messages-form-tool">
                    <a href="charts.html#" className="attachment">
                      ...
                      <li>
                        <label className="custom-checkbox custom-control checkbox-secondary">
                          ...
                          <span className="task-action">
                            <a href="charts.html#" className="link text-danger">
